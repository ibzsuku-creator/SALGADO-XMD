...
function getPrompt() {
    try {
        ...
        return JSON.parse(fs.readFileSync(p)).prompt || "Tu es SALGA-XMD, assistant WhatsApp créé par IBSACKO. Réponds en français, sois utile et concis.";
    } catch {
        return "Tu es SALGA-XMD, assistant WhatsApp créé par IBSACKO. Réponds en français, sois utile et concis.";
    }
}
